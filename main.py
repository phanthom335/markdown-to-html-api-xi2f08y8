    """
    Markdown To Html Api Xi2f08y8
    =============================
    Lightweight Flask/FastAPI microservice to forward HTTP traffic reliably.
    ...
    APP_NAME    = "Markdown To Html Api Xi2f08y8"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight Flask/FastAPI microservice to forward HTTP traffic reliably.")
